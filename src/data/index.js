...
// services
import service1 from "../assets/img/rr1.png"
...
export const servicesData = [
  {
    img: service1,
    text: "security vessel",
  },

  {
    img: service2,
    text: "supply of petroleum products",
  },

  {
    img: service3,
    text: "platform supply vessel",
  },

  {
    img: service4,
    text: "crew supply vessel",
  },
  {
    img: service5,
...
export const sellingPoints1 = [
  ...
  {
    icon: <FaCogs />,
    text: "Proficient Technical Know-How",
  },
  {
    icon: <FaCheck />,
    text: "Service Driven",
...
export const sellingPoints2 = [
  {
    icon: <FaHandshake />,
    text: "Honesty And Sincerity",
  },
  {
    icon: <FaMoneyBillAlt />,
    text: "Robust Financial Strength",
  },
  {
    icon: <FaUsers />,
    text: "High Efficiency Level",
  },
  {
    icon: <FaPaperPlane />,
  ...
  {
    icon: <FaStreetView />,
    text: "Ecologically Friendly Services",
  },
]
